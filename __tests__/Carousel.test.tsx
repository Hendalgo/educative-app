...
describe('Carousel', () => {
  ...
  it('calls onCurrentPageChange with the correct page when scrolled', () => {
    ...
    const { getByTestId } = render(<Carousel width={100} onCurrentPageChange={handleCurrentPageChange} />);
    const carousel = getByTestId('carousel');
  ...
  it('calls onScrollEnd with the correct page when scroll ends', () => {
    ...
    const { getByTestId } = render(<Carousel width={100} onScrollEnd={handleScrollEnd} />);
    const carousel = getByTestId('carousel');
