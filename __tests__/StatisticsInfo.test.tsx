...
describe('StatisticsInfo', () => {
  it('renders correctly', () => {
    const {getByText} = render(<StatisticsInfo title="Test Title" subtitle="Test Subtitle" image={require('@assets/icons/chart-icon.png')} />);
    expect(getByText('Test Title')).toBeTruthy();
    expect(getByText('Test Subtitle')).toBeTruthy();
  });

  it('applies styles correctly', () => {
    const {getByTestId} = render(<StatisticsInfo title="Test Title" subtitle="Test Subtitle" image={require('@assets/icons/chart-icon.png')} />);
