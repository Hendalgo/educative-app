...
const CarouselDot = ({index,carouselWidth: width, animation, extrapolate}:CarouselDotInterface):React.JSX.Element =>{
  const inputRange:number[] = [(index-1) * width, index * width, (index+1) * width];
  //@ts-ignore
